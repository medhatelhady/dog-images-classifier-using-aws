...
def train_model(model, dataloaders, criterion, optimizer, num_epochs, device, hook):
    since = time.time()
...
if __name__=='__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default="resnet",
        help="select pretrained model (default=resent18)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=64,
        help="number of instances per batch (default=64)"
    )
